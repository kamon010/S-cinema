...
$sql = "SELECT PosterID, Poster FROM poster_promotion";
...
img {
        max-width: 200px; /* กำหนดความกว้างสูงสุดของภาพ */
        height: auto; /* ทำให้ความสูงของภาพปรับตามอัตราส่วน */
    }
</style>
</head>
<body>
    ...
    <h2>Poster Homepage</h2>
        ...
        if ($result->num_rows > 0) {
            echo "<table class='table'>
                    ...
                    <tbody>";
            // วนลูปเพื่อแสดงข้อมูลที่ได้จากการคิวรี่
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>".$row["PosterID"]."</td>

                        <td><img src='data:image/jpeg;base64,".base64_encode($row['Poster'])."' alt='Poster' style='width:100%;height:100%;'></td>
                        
                        <td><a href='poster_edit.php?id=".$row["PosterID"]."' class='btn btn-secondary btn-xs'>Edit</a></td>
